...
<t:plantilla_admin title="Gestionar actividades - Modificar actividad">
<jsp:body>
	...
	<form:form method="post" modelAttribute="activity">
		<table class="formulario">
			...
			<tr>
				<td colspan="2" align="center"> <input type="submit" value="Guardar actividad" class="btn btn-default" /></td>
			</tr>
		</table>
	</form:form>
</jsp:body>
